...
extern int Vref, Imax, Vmax, mode;
...
void init_commands(void)
{
	...
	command_list[i].command_function = cmd_ChangeMode;
	command_list[i].command_desc = "Select converting mode: 1. Default Mode 0. Reverse Mode";
	command_list[i++].command = "mode";
