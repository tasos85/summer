...
/**
 * Config your IP address, sub net mask and gateway IP here
 */
...
#define MAX_TCP_TX_DATA_SIZE 1024                // max. outgoing TCP data size (even!)
                                                 // won't work if greater than 1024
...
#define MAX_ETH_TX_DATA_SIZE 84                  // 2nd buffer, used for ARP, ICMP, TCP (even!)
                                                 // enough to echo 56 byte via ICMP
